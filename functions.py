...
class funciones:
    ...
    def printdata (self):
        ...
        print("\tPotencia activa \t", float("{0:.2f}".format(self.ins2eff(self.pp) )))
        print("\tPotencia reactiva \t", float("{0:.2f}".format(self.ins2eff(self.pq) )))
        print("\tPotencia aparente \t", float("{0:.2f}".format(self.ins2eff(self.ps) )))
